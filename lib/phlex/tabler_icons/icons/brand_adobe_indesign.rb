class Phlex::TablerIcons::BrandAdobeIndesign < Phlex::TablerIcons::Icon
  def view_template
    svg(
      class: @class,
      ...
      s.path(
        d:
          "M14.842 11.053v3.79c0 1.044 -.49 .946 -1.42 .946a2.368 2.368 0 0 1 0 -4.736zm0 0v-2.843"
      )
      s.path(d: "M8.211 8.211v7.578")
    end
  end
end