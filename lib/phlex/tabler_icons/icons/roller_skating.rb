class Phlex::TablerIcons::RollerSkating < Phlex::TablerIcons::Icon
  def view_template
    svg(
      class: @class,
      ...
      s.path(d: "M8 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0")
      s.path(d: "M16 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0")
    end
  end
end