class Phlex::TablerIcons::BrandBaidu < Phlex::TablerIcons::Icon
  def view_template
    svg(
      class: @class,
      ...
      s.path(d: "M5 9.5m-1 0a1 1.5 0 1 0 2 0a1 1.5 0 1 0 -2 0")
      s.path(
        d:
      ...
      s.path(d: "M9 4.5m-1 0a1 1.5 0 1 0 2 0a1 1.5 0 1 0 -2 0")
      s.path(d: "M15 4.5m-1 0a1 1.5 0 1 0 2 0a1 1.5 0 1 0 -2 0")
      s.path(d: "M19 9.5m-1 0a1 1.5 0 1 0 2 0a1 1.5 0 1 0 -2 0")
    end
  end
end