class Phlex::TablerIcons::TagStarred < Phlex::TablerIcons::Icon
  def view_template
    svg(
      class: @class,
      ...
      s.path(
        d:
          "M12.5 13.847l-1.5 1.153l.532 -1.857l-1.532 -1.143h1.902l.598 -1.8l.598 1.8h1.902l-1.532 1.143l.532 1.857z"
      )
    end
  end
end