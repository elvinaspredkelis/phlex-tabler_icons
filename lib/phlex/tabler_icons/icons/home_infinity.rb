class Phlex::TablerIcons::HomeInfinity < Phlex::TablerIcons::Icon
  def view_template
    svg(
      class: @class,
      ...
      s.path(d: "M19 14v-2h2l-9 -9l-9 9h2v7a2 2 0 0 0 2 2h2.5")
      s.path(d: "M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 1.75 1.032")
      s.path(
        d:
