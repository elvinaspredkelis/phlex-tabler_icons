class Phlex::TablerIcons::PumpkinScary < Phlex::TablerIcons::Icon
  ...
  def view_template
    svg(
      ...
      s.path(d: "M9 15l1.5 1l1.5 -1l1.5 1l1.5 -1")
      s.path(d: "M10 11h.01")
      s.path(d: "M14 11h.01")
      s.path(
        d:
      ...
      s.path(d: "M12 6c0 -1.226 .693 -2.346 1.789 -2.894l.211 -.106")
    end
  end
end