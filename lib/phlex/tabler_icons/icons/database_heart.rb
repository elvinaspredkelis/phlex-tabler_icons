class Phlex::TablerIcons::DatabaseHeart < Phlex::TablerIcons::Icon
  ...
  def view_template
    svg(
      ...
      s.path(d: "M4 6v6c0 1.453 2.755 2.665 6.414 2.941")
      s.path(d: "M20 11v-5")
      s.path(d: "M4 12v6c0 1.579 3.253 2.873 7.383 2.991")
      s.path(
        d:
